...
y(t)=c_1e^{-2t}+c_2e^{-3t}
\end{equation*}}
\visible<6->{The set $\left\{e^{-2t},e^{-3t}\right\}$ is a basis of the solution space $\Sol$, and $\dim\Sol=2$.}
\onslide<7->
\begin{figure}
\centering
...
\visible<3->{=(r+1)(r-1)}
\end{equation*}}
\visible<4->{which has solutions $r_1=1$ and $r_2=-1$.}
\visible<5->{
...
y(t)=c_1e^{t}+c_2e^{-t}
\end{equation*}}
\visible<6->{The set $\left\{e^{t},e^{-t}\right\}$ is a basis of the solution space $\Sol$, and $\dim\Sol=2$.}
\onslide<7->
\begin{figure}
\centering
\begin{subfigure}[b]{0.4\textwidth}
...
\visible<3->{={(r-2)}^2}
\end{equation*}}
\visible<4->{which has solutions $r=2$.}
\visible<5->{
...
\end{equation*}}
\visible<6->{The set $\left\{e^{2t},te^{2t}\right\}$ is a basis of the solution space $\Sol$, and $\dim\Sol=2$.}
\onslide<7->
\begin{figure}
\centering
\begin{subfigure}[b]{0.4\textwidth}
...
\visible<3->{=(r+1)(r+2)}
\end{equation*}}
\visible<4->{which has solutions $r_1=-1$ and $r_2=-2$.}
\visible<5->{
...
x(t)=c_1e^{-t}+c_2e^{-2t}
\end{equation*}}
\visible<6->{The set $\left\{e^{-t},e^{-2t}\right\}$ is a basis of the solution space $\Sol$, and $\dim\Sol=2$.}
\onslide<7->
\begin{figure}
\centering
\begin{subfigure}[b]{0.4\textwidth}
...
\visible<3->{={(r+3)}^2}
\end{equation*}}
\visible<4->{which has solution $r=-3$.}
\visible<5->{
...
\end{equation*}}
\visible<6->{The set $\left\{e^{-3t},te^{-3t}\right\}$ is a basis of the solution space $\Sol$, and $\dim\Sol=2$.}
\onslide<7->
\begin{figure}
\centering
\begin{subfigure}[b]{0.4\textwidth}

...
\begin{frame}{Linear System of Equations}{Notation}
There are two primary ways of writing a linear systems using matrices:\pause
...
\begin{frame}{Row Operations}{(for Augmented Matrices)}
...
\begin{frame}{Solving Augmented Matrices}{Row Echelon Form}
\begin{block}{Gaussian Elimination}
\small
Use row operations until in REF\@:
\begin{equation*}
...
\begin{frame}{Gaussian Elimination}{Example}
\begin{example}
\begin{overprint}
\onslide<1-2>
Consider the system
...
An augmented matrix is said to be in \textbf{Reduced Row Echelon Form} if:
\begin{equation*}
\begin{bmatrix}[ccc|c]
1&\cdots&0&k_1\\

...
for (real m : vals)
{
    ...
    draw(graph(fp,min_x, max_x), dashed+grey+0.75bp);
    draw(graph(fn,min_x, max_x), dashed+grey+0.75bp);
...
for (real m : vals)
{
    ...
    draw(graph(fp,-1*m, max_x), dashed+grey+0.75bp);
    draw(graph(fn,-1*m, max_x), dashed+grey+0.75bp);

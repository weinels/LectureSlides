...
\end{equation*}}
\visible<4->{Just like with second-order systems, we shall find that the real and imaginary parts of the complex solution above are both real and linearly independent solutions of the system.}
\onslide<5-11>
Suppose that
\begin{equation*}
...
\end{equation*}}
\visible<10->{Separately equating the real and imaginary parts, we get:
\begin{equation*}
\xReal^\prime(t)=\mat{A}\xReal(t)
\quad\text{and}\quad
\xImag^\prime(t)=\mat{A}\xImag(t)
\end{equation*}}
\visible<11->{Thus, $\xReal(t)$ and $\xImag(t)$ are separate real solutions to the system.}
\onslide<12-18>
...
&\only<13-16>{\phantom{=e^{\alpha t}\left(\cos[\beta t]\vect{p}-\sin[\beta t]\vect{q}\right)+i e^{\alpha t}\left(\sin[\beta t]\vect{p}+\cos[\beta t]\vect{q} \right)}}%
\only<17>{=e^{\alpha t}\left(\cos[\beta t]\vect{p}-\sin[\beta t]\vect{q}\right)+i e^{\alpha t}\left(\sin[\beta t]\vect{p}+\cos[\beta t]\vect{q} \right)}%
\only<18->{=\underbrace{e^{\alpha t}\left(\cos[\beta t]\vect{p}-\sin[\beta t]\vect{q}\right)}_{\xReal(t)}+i \underbrace{e^{\alpha t}\left(\sin[\beta t]\vect{p}+\cos[\beta t]\vect{q} \right)}_{\xImag(t)}}\\
\end{aligned}
\end{equation*}}
\onslide<19->
...
\end{aligned}
\end{equation*}}
\visible<4->{And general solution
\begin{equation*}

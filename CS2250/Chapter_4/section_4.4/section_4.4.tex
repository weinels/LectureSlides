...
\end{equation*}
\visible<2->{Let us look for $y_p$ in $\Poly_2$. Which means $y_p$ will be in the form
\begin{equation*}
y_p=At^2+Bt+C
\end{equation*}}
...
\end{equation*}
\visible<2->{Let us look for $y_p$ of the form
\begin{equation*}
y_p=Ae^{-3t}
\end{equation*}}
\visible<3->{We can then calculate:
...
\vspace{-4mm}
\visible<11->{This is also a problem. We'll have to try something else.}
\onslide<12-13>
Consider
\begin{equation*}
...
\visible<17->{And so, the particular solution is
\begin{equation*}
y_p=\dfrac{5}{2}te^{2t}
\end{equation*}}
\end{overprint}

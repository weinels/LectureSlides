...
%	\begin{equation*}
		$\left[
			\begin{array}{rr}
				\tikzmarkin<8>[hor=style green]{end-a}\visible<8->{\+2} \tikzmarkend{end-a}\\
				\tikzmarkin<9>[hor=style green]{end-b}\visible<9->{-1}\tikzmarkend{end-b}\\
				 \tikzmarkin<10>[hor=style green]{end-c}\visible<10->{\+1}\tikzmarkend{end-c} 
			\end{array}
		\right]$
%	\end{equation*}
\end{minipage}

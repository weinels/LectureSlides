...
&&\outcome{yes}&\outcome{no}&Total &&\outcome{yes}&\outcome{no}&Total  \\\cline{2-5}\cline{7-9}
\multirow{2}{*}{\variable{result}} & \outcome{lived} & 238 & 5136 & 5374 && 0.0382 & 0.8252 & 0.8634  \\
&\outcome{died} & 6 & 844 & 850 && \color<4>{red!75}{0.0010} & 0.1356 & 0.1366 \\\cline{2-5}\cline{7-9}
&Total & 244 & 5980 & 6224 && \color<4>{blue!75}{0.0392} & 0.9608 & 1.0000
\end{tabular}
\end{center}
...
\qquad=\dfrac{\color<4>{red!65}{0.0010}}{\color<4>{blue!65}{0.0392}} \\[4mm]\pause
...
\vspace{2mm}
\question{Is this study observational or experimental?}\pause
\answer{Observational}\pause

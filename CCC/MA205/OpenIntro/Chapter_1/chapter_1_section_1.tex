...
&\multicolumn{2}{c}{\variable{0-30 days}}&&\multicolumn{2}{c}{\variable{0-365 days}} \\
&\outcome{stroke} & \outcome{no event} & & \outcome{stroke}& \outcome{no event} \\\hline
\outcome{treatment} & 33 & 191 & & 45 & 179 \\
\outcome{control} & 13 & 214 & & 28 & 199 \\\hline
\outcome{total} & 46 & 405 & & 73 & 378\\
\end{tabular}
\end{center}
\end{block}\pause

...
\begin{frame}{Third-Order Initial-Value Problem Example}
\begin{example}
\usepercentframe{0.77}{
\only<1-2>{An engineering consultant finds that she must solve the following IVP\@:
\begin{equation*}
...
\end{equation*}
(We will talk about to solve this type of DE in Chapter 4.)}
